...
@section('form_action', route('vendors.store'))
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        <h5>{{ __('general.create') }} {{ __('general.vendors') }}</h5>
                                    </div>
                                    ...
                                    <!-- Normal title input -->
                                    <div class="mb-4 row align-items-center"> <label
                                            class="form-label-title col-sm-3 mb-0">{{ __('general.contact_info') }} <span
                                                class="text-danger"> * </span></label>
                                        <div class="col-sm-9"> <input type="string" placeholder="{{ __('general.contact_info') }}"
                                                class="form-control @error('contact_info') is-invalid @enderror"
                                                value="{{ old('contact_info') }}" name="contact_info"> </div>
                                    </div>
