                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4 row align-items-center"> <label
                                                    class="form-label-title col-sm-3 mb-0">{{ __('general.duration') }} <span
                                                        class="text-danger"> * </span></label>
                                                <div class="col-sm-9"> <input type="string" placeholder="{{ __('general.duration') }}"
                                                        class="form-control @error('duration') is-invalid @enderror"
                                                        value="{{ old('duration') }}" name="duration"> </div>
                                            </div>
                                        </div>
